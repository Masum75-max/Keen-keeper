...
const GreatDetail = ({id}) => {
    ...
    const friend = friends.find(friend => parseInt(friend.id) === parseInt(id));
    console.log(friend);
    return (
        <div>
  ...
  <div className="max-w-5xl w-full grid grid-cols-12 gap-6">
    ...
    <div className="col-span-4 space-y-4">
      <div className="bg-white rounded-xl p-8 border border-slate-100 shadow-sm text-center">
        <Image src={friend.picture} alt={friend.name} width={120} height={120} className="w-32 h-32 rounded-full mx-auto mb-4 object-cover" />
        ...
        <p className="text-slate-400 text-xs">Preferred: {friend.email}</p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <button className="w-full bg-white border border-slate-100 py-3 rounded-lg text-slate-700 flex items-center justify-center gap-2 hover:bg-slate-50 transition shadow-sm font-medium">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"></path></svg>
          Archive
        </button>
    ...
    <div className="col-span-8 space-y-6">
      ...
      <div className="bg-white p-8 rounded-xl border border-slate-100 shadow-sm">
        ...
        <div className="grid grid-cols-3 gap-4">
          <button className="flex flex-col items-center justify-center p-6 bg-slate-50 rounded-xl hover:bg-slate-100 transition group">
            <svg className="w-6 h-6 text-slate-700 mb-2 group-hover:scale-110 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLineCap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
          ...
          <button className="flex flex-col items-center justify-center p-6 bg-slate-50 rounded-xl hover:bg-slate-100 transition group">
            <svg className="w-6 h-6 text-slate-700 mb-2 group-hover:scale-110 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 
0 002 2z"></path></svg>
